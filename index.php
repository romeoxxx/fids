    ...
    if (!empty($data['entry'][0]['messaging'])) {
        foreach ($data['entry'][0]['messaging'] as $message) {
            ...
            if($command == '/his'){
                ...
                $msg = array(new MessageElement("First item", "Item description", "", null),new MessageElement("First item", "Item description", "", null),new MessageElement("First item", "Item description", "", null),new MessageElement("First item", "Item description", "", null),new MessageElement("First item", "Item description", "", null));
                $bot->send(new StructuredMessage($message['sender']['id'],
                        StructuredMessage::TYPE_GENERIC,
                        [
                            'elements' => $msg
